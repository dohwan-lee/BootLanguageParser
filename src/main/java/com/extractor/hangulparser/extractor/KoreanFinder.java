...
@Component
public class KoreanFinder implements LanguageExtractorInterface {

    public List<FileInfo> findLanguageExtractor(File file) throws Exception {
        ...
        try (BufferedReader bis = new BufferedReader(new InputStreamReader(fis))) {
            ...
            while ((line = bis.readLine()) != null) {
                ...
                if (isKor == true) {
                    ...
                    fi.setFileName(FilenameUtils.getBaseName(file.getName()));
                    fi.setFilePath(file.getAbsoluteFile());
                    fi.setFilePullName(file.getName());
